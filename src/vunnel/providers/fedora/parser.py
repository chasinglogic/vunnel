...
class Parser:
    ...
    _rss_file_name_ = "fedora_rss.xml"
    _html_dir_name_ = "fedora_html"
...
#                 element.clear()
    ...
    def _get(self):
        url = "https://bodhi.fedoraproject.org/rss/updates/?type=security"
        rss_file = os.path.join(self.workspace.input_path, self._rss_file_name_)
        html_dir = os.path.join(self.workspace.input_path, self._html_dir_name_)
